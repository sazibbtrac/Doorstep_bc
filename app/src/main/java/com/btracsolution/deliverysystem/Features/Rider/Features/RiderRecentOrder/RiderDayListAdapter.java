...
public class RiderDayListAdapter extends RecyclerView.Adapter<MainViewHolder> {
    ...
    public RiderDayListAdapter(Context context, ArrayList<OrderDetailsModel.orderBasicData> orderBasicDatas, BaseItemClickListener baseItemClickListener) {
    ...
    public MainViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        switch (viewType) {
            case TYPE_JOB:
                return new RiderDayViewHolder(LayoutInflater.from(context).inflate(R.layout.row_rider_my_day_item, parent, false));
    ...
    public void onBindViewHolder(MainViewHolder holder, int position) {
        ...
        switch (holder.getItemViewType()) {
            case TYPE_JOB:
                RiderDayViewHolder AgentDayViewHolder = (RiderDayViewHolder) holder;
