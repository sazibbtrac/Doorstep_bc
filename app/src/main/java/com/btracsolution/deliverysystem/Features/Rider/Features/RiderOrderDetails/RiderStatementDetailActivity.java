...
public class RiderStatementDetailActivity extends BaseActivity<ActivityStatementDetailsBinding>   {


    public static void open(Context context) {
        Intent intent = new Intent(context, RiderStatementDetailActivity.class);
    ...
    private void initializeToolbar() {
        if (Build.VERSION.SDK_INT >= 21) {
            getWindow().setStatusBarColor(
                    ContextCompat.getColor(RiderStatementDetailActivity.this, R.color.colorAccent));
        }
