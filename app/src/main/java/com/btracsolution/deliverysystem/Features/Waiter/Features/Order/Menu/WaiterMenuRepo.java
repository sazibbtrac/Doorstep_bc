...
public class WaiterMenuRepo {
    ...
    public WaiterMenuRepo(Context context, BaseServerListener baseServerListener) {
        ...
        if (Connectivity.isConnected(context)) {
            if (retroHubApiInterface != null) {
                if (sharedData.getMyData() != null) {
                    apitoken = sharedData.getMyData().getData().getApiToken();
