...
public class AgentAllRiderViewHolder extends MainViewHolder implements View.OnClickListener{

    public BaseItemClickListenerRiderSelect baseItemClickListener;
    private AgentAllRiderListBinding binding;
...
*/
    ...
    public AgentAllRiderViewHolder(View itemView) {
        super(itemView);
        binding = AgentAllRiderListBinding.bind(itemView);
