...
public class AgentJobListAdapter extends RecyclerView.Adapter<MainViewHolder> {
    ...
    public AgentJobListAdapter(Context context, ArrayList<OrderDetailsModel.orderBasicData> orderBasicDatas, BaseItemClickListener baseItemClickListener) {
