...
public class AgentRowInsideDetailAdapter extends RecyclerView.Adapter<MainViewHolder> {
    ...
    public AgentRowInsideDetailAdapter(Context context, ArrayList<OrderDetailsModel.OrderItem> orderBasicDatas, BaseItemClickListener baseItemClickListener) {
    ...
    public MainViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        switch (viewType) {
            case TYPE_JOB:
                return new AgentRowInside(LayoutInflater.from(context).inflate(R.layout.row_inside_job_two_generic_2, parent, false));
            default:
                return new AgentRowInside(LayoutInflater.from(context).inflate(R.layout.row_inside_job_two_generic_2, parent, false));
    ...
    public void onBindViewHolder(MainViewHolder holder, int position) {
        ...
        switch (holder.getItemViewType()) {
            case TYPE_JOB:
                AgentRowInside agentJobListViewHolder = (AgentRowInside) holder;
