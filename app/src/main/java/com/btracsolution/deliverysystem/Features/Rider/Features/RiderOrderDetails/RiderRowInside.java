...
public class RiderRowInside extends MainViewHolder {
...
/*
    ...
    public RiderRowInside(View itemView) {
        super(itemView);
...
//            ToppingText += "+" + OrderItem.getOrderitemaddon().get(i).getAddon_info().getFoodname() + " - ৳ " + OrderItem.getOrderitemaddon().get(i).getAddon_info().getPrice() + "\n";
//        }
